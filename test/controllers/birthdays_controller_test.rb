...
class BirthdaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create birthday" do
    assert_difference('Birthday.count') do
      post birthdays_url, params: { birthday: { fecha: @birthday.fecha, nombre: @birthday.nombre } }
    end
  ...
  test "should update birthday" do
    patch birthday_url(@birthday), params: { birthday: { fecha: @birthday.fecha, nombre: @birthday.nombre } }
